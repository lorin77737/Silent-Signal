...
How to Connect:
Power the ESP32.
Connect to WiFi: Sensor Syndicate
Open browser.
Visit: 192.168.4.1
Dashboard loads automatically (captive portal enabled).
📊 Dashboard Overview
...
Vibration Detected
Yellow Blinking
Critical (Temp > 45°C / Vibration / Manual Alarm)
Orange ON + Buzzer ON
🔊 Alert Logic
